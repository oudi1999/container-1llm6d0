...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-1llm6d0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-1llm6d0.containers.anotherwebservice.com/
...
```
git clone git@github.com:oudi1999/container-1llm6d0.git
cd container-1llm6d0
```
...
```
docker attach container-1llm6d0
```
